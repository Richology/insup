...
export const XHSLongImagePreview = forwardRef<HTMLDivElement, XHSLongImagePreviewProps>(
  ({ 
    html, 
    theme, 
    authorName = "InSup 创作助手",
    authorAvatar = "https://api.dicebear.com/7.x/avataaars/svg?seed=InSup",
    tags = ["内容洞察", "课程设计", "InSup"],
    showHeader = true,
    showFooter = true
  }, ref) => {
    return (
      ...
      >
        ...
        {showHeader && (
          <div className="xhs-header">
            ...
            <div className="xhs-header-info">
              ...
              <div className="xhs-header-badge">由 InSup 生成</div>
            </div>
          </div>
        )}
        ...
        <div className="xhs-watermark">InSup</div>
      </div>
    );
  }
);

...
export function getXHSContentCSS(themeCSS: string, fontValue?: string): string {
  // 将主题中的 #insup-content 替换为 #xhs-content 以适配小红书预览
  const adjustedCSS = themeCSS.replace(/#insup-content/g, "#xhs-content");
  ...
  return `
    ...
    #xhs-content #insup-content > *:last-child {
      margin-bottom: 0 !important;
    }
    #xhs-content #insup-content h1,
    #xhs-content #insup-content h2,
    #xhs-content #insup-content h3 {
    ...
    #xhs-content #insup-content h1::before, 
    #xhs-content #insup-content h1::after,
    #xhs-content #insup-content h2::before,
    #xhs-content #insup-content h2::after {
    ...
    #xhs-content #insup-content p::first-letter {
...
async function calculateSlides(
  ...
  const measureHeight = async (nodes: Node[], waitForImage = false) => {
    ...
    // Wrap in #xhs-content AND #insup-content so XHS-specific theme overrides apply during measurement
    const themeWrap = document.createElement("div");
    themeWrap.id = "insup-content";
          ...
          >
            {displaySlides.map((slide, i) => (
              <div
                ...
                className="xhs-slide-page export-page"
                style={{
                  width: `${XHS_CARD_W}px`,
                  flexShrink: 0,
                  height: "100%",
              ...
              >
                ...
                >
                  ...
                  >
                    <div id="insup-content" dangerouslySetInnerHTML={{ __html: slide.html }} />
                  </div>
                </div>
              </div>
            ))}
